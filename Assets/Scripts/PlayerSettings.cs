...
public static class PlayerSettings {
   ...
   private static float scrambleRotationTime;
   private static int scrambleTimes;
   ...
   private static bool scrambling;
    ...
    public static int ScrambleTimes
    {
        get
        {
    ...
    public static float ScrambleRotationTime
    {
        get
        {
            return scrambleRotationTime;
        }
        set
        {
            scrambleRotationTime = value;
        }
    }
